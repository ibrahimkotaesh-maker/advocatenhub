...
const SPECIALTY_BLOG_MAP: Record<string, string[]> = {
    ...
    familierecht: ['echtscheiding-kosten', 'wat-kost-een-advocaat', 'gesubsidieerde-rechtsbijstand'],
    arbeidsrecht: ['vaststellingsovereenkomst', 'transitievergoeding-berekenen', 'wat-kost-een-advocaat'],
